...
public class TestAccountDAO {
	...
	@Test
	public void testGetAllAccounts() throws MoneyTransferException {
	...
	public void testGetAccountById() throws MoneyTransferException {
		...
		assertTrue(account.getUserName().equals("barry"));
	}
	...
	@Test
	public void testGetNonExistingAccByI0d() throws MoneyTransferException {
		Account account = h2DaoFactory.getAccountDAO().getAccountById(0);
		assertTrue(account == null);
	}
	
	@Test
	public void testGetNonExistingAccByNegativeId() throws MoneyTransferException {
		Account account = h2DaoFactory.getAccountDAO().getAccountById(-100L);
		assertTrue(account == null);
	}
	...
	public void testCreateAccount() throws MoneyTransferException {
		...
		long accountId = h2DaoFactory.getAccountDAO().createAccount(a);
		Account afterCreation = h2DaoFactory.getAccountDAO().getAccountById(accountId);
	...
	@Test
	public void testDeleteAccount() throws MoneyTransferException {
	...
	@Test
	public void testDeleteNonExistingAccount() throws MoneyTransferException {
	...
	@Test
	public void testUpdateAccountBalanceSufficientFund() throws MoneyTransferException {
	...
	public void testUpdateAccountBalanceNotEnoughFund() throws MoneyTransferException {
